...
void ::CSC_Regex_Tester::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::CSC_Regex_Tester::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
